...
const LeftArrow = (props: any) => {
  ...
  return (
    <div
      className="absolute left-1/2 bottom-[-9rem] transform -translate-x-[120%] cursor-pointer xl:block hidden
...
const RightArrow = (props: any) => {
  ...
  return (
    <div
      className="absolute right-1/2 bottom-[-9rem] transform translate-x-[120%] cursor-pointer xl:block hidden
      transition-all duration-300 ease-in-out bg-indigo-600 hover:scale-110 hover:bg-indigo-700 hover:shadow-lg"
      onClick={onClick}
      style={{
        boxShadow: "4px 4px 0px rgba(0, 0, 0, 0.2)",
